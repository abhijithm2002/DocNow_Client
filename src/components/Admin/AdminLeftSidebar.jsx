...
const AdminLeftSidebar = () => {
   return (
      <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-gray-50 dark:bg-gray-900" aria-label="Sidebar">
            ...
            <ul className="space-y-5 font-medium">
               <li className='m-7'>
                  <Link to='/admin' className="flex items-center p-2 text-gray-900 rounded-lg dark:text-yellowColor hover:bg-white-100 dark:hover:bg-blue-500 group">
                     <span className="ms-3 font-bold text-2xl">DocNow</span>
                  </Link>
               </li>
               <li>
               ...
               <li>
                  ...
                  >
                     ...
                     <span className="flex-1 ms-3 whitespace-nowrap">Doctors List</span>
                  </Link>
               </li>
               <li>
                  <Link to="/admin/report-management" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-yellow-500 group">
