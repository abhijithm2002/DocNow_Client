            ...
            {bookings.length > 0 ? (
              bookings.map((booking) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 md:px-6 md:py-4 font-semibold">{new Date(booking.date).toLocaleDateString()}</td>
  ...
  {bookings.length > 0 ? (
    bookings.map((booking) => (
      ...
      >
        ...
        <p className="text-sm text-gray-600 mb-2"><strong>Specialization:</strong> {booking.doctorId.expertise}</p>
        <p className="text-sm text-gray-600 mb-2"><strong>Amount:</strong> {booking.fee}</p>
        <p className="text-sm text-gray-600 mb-4"><strong>Shift:</strong> {booking.shift}</p>
